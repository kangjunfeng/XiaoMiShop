/**
 * Created by kk on 2017/7/9.
 */
$(document).ready(function () {
    $("#menu_wrap").children().hover(function(){
        $(this).css("background","#ff6700");
        $(this).children(".menu_content").css("border","1px solid #F0F0F0").show();
    },function(){
        $(this).css("background","none");
        $(this).children(".menu_content").css("border","0px solid #F0F0F0").hide();
    });
});
